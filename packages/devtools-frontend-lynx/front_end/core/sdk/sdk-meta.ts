...
const UIStrings = {
  ...
  */
  preserveLogUponNavigation: 'Preserve log on reload',
  /**
  *@description Title of a setting under the Console category that can be invoked through the Command Menu
  */
  doNotPreserveLogUponNavigation: 'Do not preserve log on reload',
  /**
  ...
  *@description Title of a setting under the Screencast category that can be invoked through the Command Menu
  */
  setScreencastFPS1: 'Set screencast FPS to 1',
  /**
  *@description Title of a setting under the Screencast category that can be invoked through the Command Menu
  */
  setScreencastFPS2: 'Set screencast FPS to 2',
  /**
  *@description Title of a setting under the Screencast category that can be invoked through the Command Menu
  */
  setScreencastFPS5: 'Set screencast FPS to 5',
  /**
  *@description Title of a setting under the Screencast category that can be invoked through the Command Menu
  */
  setScreencastFPS8: 'Set screencast FPS to 8',
  /**
  *@description Whether to show all source js files in Lynx shared-context scene
  */
  showLynxSourcesFromSharedContextCards: 'Show Lynx sources from other shared-context cards',
};
...
Common.Settings.registerSettingExtension({
  ...
  options: [
    ...
    {
      title: i18nLazyString(UIStrings.setScreencastFPS2),
      text: i18nLazyString('2'),
      value: '2',
    },
    {
      title: i18nLazyString(UIStrings.setScreencastFPS5),
      text: i18nLazyString('5'),
      value: '5',
    },
    {
      title: i18nLazyString(UIStrings.setScreencastFPS8),
