...
// File is generated by devtools-frontend-lynx/scripts/build/code_generator_frontend.py
...
export function registerCommands(inspectorBackend) {
  ...
  inspectorBackend.registerCommand(
      'DOM.enable',
      [
        {'name': 'useCompression', 'type': 'boolean', 'optional': false},
        {'name': 'compressionThreshold', 'type': 'number', 'optional': true}
      ],
      []);
  inspectorBackend.registerCommand(
      'DOM.focus',
  ...
  inspectorBackend.registerCommand(
      'Lynx.getProperties', [{'name': 'nodeId', 'type': 'number', 'optional': false}], ['properties']);
  inspectorBackend.registerCommand('Lynx.getData', [{'name': 'nodeId', 'type': 'number', 'optional': false}], ['data']);
  inspectorBackend.registerCommand(
      'Lynx.setTraceMode', [{'name': 'enableTraceMode', 'type': 'boolean', 'optional': false}], []);
