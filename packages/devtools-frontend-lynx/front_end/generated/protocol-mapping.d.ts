...
export namespace ProtocolMapping {
  export interface Events {
     ...
     */
    'Debugger.removeScriptsForLynxView': [Protocol.Debugger.RemoveScriptsForLynxViewEvent];
    /**
  ...
  export interface Commands {
    ...
    'Lynx.getProperties':
        {paramsType: [Protocol.Lynx.GetPropertiesRequest]; returnType: Protocol.Lynx.GetPropertiesResponse;};
    'Lynx.getData': {paramsType: [Protocol.Lynx.GetDataRequest]; returnType: Protocol.Lynx.GetDataResponse;};
    'Lynx.setTraceMode': {paramsType: [Protocol.Lynx.SetTraceModeRequest]; returnType: void;}
    /**
     * Returns supported domains.
     */
    'Schema.getDomains': {paramsType: []; returnType: Protocol.Schema.GetDomainsResponse;};
    'DOM.getOriginalNodeIndex': {paramsType: [Protocol.DOM.GetOriginalNodeIndexRequest?]; returnType: Protocol.DOM.GetOriginalNodeIndexResponse;};
  }
}
