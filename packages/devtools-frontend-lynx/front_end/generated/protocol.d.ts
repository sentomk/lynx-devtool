...
declare namespace Protocol {
  ...
  export namespace DOM {
    ...
    export interface GetOriginalNodeIndexRequest {
      /**
       * Identifier of the node.
       */
      nodeId: NodeId;
    ...
    export interface GetOriginalNodeIndexResponse extends ProtocolResponseWithError {
      /**
       * NodeIndex for the node.
       */
      nodeIndex: integer;
    }
    ...
    export interface GetDocumentResponse extends ProtocolResponseWithError {
      ...
      root: Node;
      /**
       * Indicates whether root data was compressed.
       */
      compress?: boolean;
    }
  ...
  export namespace Debugger {
    ...
    export interface EnableResponse extends ProtocolResponseWithError {
      ...
      /**
       * JS engine type of the debugger.
       */
      engineType?: string;
    }
    ...
    /**
     * Fired when shared-context lynxView destroy
     */
    export interface RemoveScriptsForLynxViewEvent {
      /**
  ...
  export namespace Runtime {
    ...
    /**
     * Console log identities for lynx
     */
    export interface Identities {
      ...
      // id of lynxview
      viewId?: number;
      // id of group sharing context
      groupId?: string;
      // tag of console source (Lepus)
      consoleTag?: string;
    }
    ...
    export interface ConsoleAPICalledEvent {
      ...
      context?: string;
      /**
       * Special params for lynx shared-context.
       */
      // id of js runtime
      consoleId?: number;
      // id of lynxview
  ...
  export namespace Lynx {
    ...
    export interface GetComponentIdResponse extends ProtocolResponseWithError {
      /**
       * Id of the component.
       */
      componentId: number;
    ...
    export interface GetDataResponse extends ProtocolResponseWithError {
      /**
       * Id of the component.
       */
      data: string;
     ...
     * set trace mode
     */
    export interface SetTraceModeRequest {
      enableTraceMode: boolean;
    }

    export interface SetTraceModeResponse extends ProtocolResponseWithError {}
  }
