...
declare namespace ProtocolProxyApi {
  ...
  export interface DOMApi {
    ...
    /**
     * Returns node_index for the given node.
     */
    invoke_getOriginalNodeIndex(params: Protocol.DOM.GetOriginalNodeIndexRequest): Promise<Protocol.DOM.GetOriginalNodeIndexResponse>;
  ...
  export interface DebuggerDispatcher {
     ...
     */
    removeScriptsForLynxView(params: Protocol.Debugger.RemoveScriptsForLynxViewEvent): void;
  ...
  export interface LynxApi {
    invoke_getComponentId(params: Protocol.Lynx.GetComponentIdRequest): Promise<Protocol.Lynx.GetComponentIdResponse>;

    invoke_getProperties(params: Protocol.Lynx.GetPropertiesRequest): Promise<Protocol.Lynx.GetPropertiesResponse>;

    invoke_getData(params: Protocol.Lynx.GetDataRequest): Promise<Protocol.Lynx.GetDataResponse>;

    /**
     * set trace mode
     */
    invoke_setTraceMode(params: Protocol.Lynx.SetTraceModeRequest) : void;
  }
  export interface LynxDispatcher {}
